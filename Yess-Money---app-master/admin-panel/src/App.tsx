...
function App() {
  const [language, setLanguage] = React.useState(localStorage.getItem('language') || 'ru');
      ...
      <QueryClientProvider client={queryClient}>
        <ConfigProvider
          ...
          theme={{
            ...
            components: {
              Menu: {
                itemSelectedBg: 'linear-gradient(135deg, #F5A623 0%, #F7B731 50%, #FFC859 100%)',
                itemSelectedColor: '#ffffff',
                itemHoverBg: '#FFF4E6',
                itemActiveBg: 'linear-gradient(135deg, #F5A623 0%, #F7B731 50%, #FFC859 100%)',
                itemBorderRadius: 12,
              },
              Button: {
                borderRadius: 12,
                primaryShadow: '0 4px 16px rgba(245, 166, 35, 0.4)',
                fontWeight: 600,
              },
              Card: {
                borderRadius: 16,
                boxShadow: '0 2px 16px rgba(245, 166, 35, 0.12)',
                paddingLG: 24,
              },
              Input: {
                borderRadius: 12,
              ...
              Table: {
                borderRadius: 12,
                headerBg: 'linear-gradient(135deg, #FFF4E6 0%, #ffffff 100%)',
                headerColor: '#8B4513',
              },
            },
          }}
