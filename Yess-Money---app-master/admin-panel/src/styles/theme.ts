...
// Новая централизованная темизация для Yess!
...
export const adminTheme = {
  ...
  colors: {
    primary: '#F5A623',
    accent: '#FFC859',
    bgGradient: 'linear-gradient(135deg, #F5A623 0%, #F7B731 50%, #FFC859 100%)',
    cardBg: '#FFF4E6',
    textHeader: '#8B4513',
  },
};
...
export const partnerTheme = {
  ...
  colors: {
    primary: '#37946e',
    accent: '#bee3b6',
    bgGradient: 'linear-gradient(135deg, #217A44 0%, #69bb7b 80%, #bee3b6 100%)',
    cardBg: '#bee3b620',
    textHeader: '#217A44',
  },
};
