...
export const ProfilePage = () => {
  ...
  return (
    <div>
      <h1 style={{ fontSize: 32, fontWeight: 700, marginBottom: 8, color: '#223732' }}>
        👤 Профиль партнера
      </h1>
      <p style={{ color: '#37946e', marginBottom: 24, fontSize: 14 }}>
      ...
      <Row gutter={[16, 16]}>
        <Col xs={24} lg={8}>
          ...
          >
            ...
            />
            <h2 style={{ color: '#223732', marginTop: 0 }}>Ваш профиль</h2>
            <p style={{ color: '#37946e', marginBottom: 16 }}>Обновлено: 2 часа назад</p>
            <Upload>
              <Button
                type="primary"
                icon={<UploadOutlined />}
        ...
        <Col xs={24} lg={16}>
          <Card
            title={<span style={{ color: '#223732', fontSize: 16, fontWeight: 700 }}>ℹ️ Основная информация</span>}
            style={{
              borderRadius: 16,
              background: 'linear-gradient(135deg, #ffffff 0%, #e3eed4 100%)',
