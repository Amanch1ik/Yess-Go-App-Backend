// Полноценная система интернационализации для партнер-панели
...
export const t = (key: string, defaultValue?: string, params?: Record<string, string | number>) => i18n.t(key, defaultValue, params);
